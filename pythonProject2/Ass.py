...
input_operation: str=input("Enter the operation to be perfomed use the first 3 letters as a word to perform operation like(add,sub,mul,div)anycases are accepted:")
